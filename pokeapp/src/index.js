...
function App() {
  ...
  // This function finds a random number between 1 and 151
  const pokeId = () => {
  ...
  return (
    <div className="app-wrapper">
      ...
      <section className="wild-pokemon">
        <h2>A wild Pokemon has appered!</h2>
        ...
        <button className="find-btn" onClick={() => encounterWildPokemon()}>FIND ANOTHER!</button>
      </section>
